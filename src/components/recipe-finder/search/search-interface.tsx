...
const COMMON_INGREDIENTS = [
  'nasi', 'ayam', 'telur', 'keju', 'bawang', 'lada', 'bawang putih',
  'tomato', 'garam', 'pasta'
];
...
const SearchInterface = ({ onSearchClick }: SearchInterfaceProps) => {
  ...
  const handleIngredientClick = (ingredient: string) => {
    setSearchQuery(prevQuery => {
      const ingredients = prevQuery.split(',').map(i => i.trim()).filter(i => i !== '');
        ...
        <div className="flex flex-col items-center mb-16">
          <div className="w-full max-w-2xl">
            <form onSubmit={handleSearch} className="relative mb-8 space-y-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-green-100 focus:border-green-200 focus:ring-2 focus:ring-green-100 focus:outline-none text-lg shadow-sm transition-all min-h-[100px] resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-colors disabled:bg-green-300 text-lg font-medium shadow-sm"
              >
                {isLoading ? (
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <div className="bg-black text-white font-bold text-2xl px-4 py-2 rounded-lg">
                5.0
              </div>
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <button 
                    ...
                    onClick={() => {/* Add view recipe handler */}}
                  >
                    View Recipe
                  </button>
                </div>
